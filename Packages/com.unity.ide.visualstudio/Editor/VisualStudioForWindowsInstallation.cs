...
#pragma warning disable CS0649
		...
		internal class VsWhereResult
		{
			...
			{
				// We've seen issues where vswhere output contains unescaped backslashes in some fields
				// which causes JsonUtility to fail.
...
#pragma warning restore CS3021
		...
		{
			var result = ProcessRunner.StartAndWaitForExit(progpath, arguments, encoding: System.Text.Encoding.UTF8);
